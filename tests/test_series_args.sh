#!/bin/bash
#
# series argument parsing tests (offline)
...
source "$PROJECT_DIR/skills/polymarket-query/scripts/commands_series.sh"
...
echo "[Test 1] basic argument parsing"
...
echo "[Test 2] equals-sign argument parsing"
...
echo "[Test 3] --out depends on --format"
