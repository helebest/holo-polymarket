"""Synchronize the generated plugin skills copy from the canonical skills dir."""
...
def sync_plugin_skills(destination: Path = PLUGIN_SKILLS_DIR) -> Path:
    """Replace the generated plugin skills directory from the canonical skills."""
...
def check_plugin_layout() -> list[str]:
    """Validate tracked plugin metadata and the generated skills copy."""
    try:
        validate_all()
